...
func DissociateWithToken(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	if req.ClientToken == "" {
	...
	minted, err := t_svc.DissociateWithToken(tokenID, userID, operatorID)
	if err != nil {
