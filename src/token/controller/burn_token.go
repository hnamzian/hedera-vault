...
func BurnToken(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	if req.ClientToken == "" {
	...
	minted, err := t_svc.BurnToken(tokenID, uint64(amount), supplyID, operatorID)
	if err != nil {
