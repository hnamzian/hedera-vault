...
func UnfreezeAccount(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	if req.ClientToken == "" {
	...
	minted, err := t_svc.UnfreezeAccount(tokenID, userID, kycID, operatorID)
	if err != nil {
