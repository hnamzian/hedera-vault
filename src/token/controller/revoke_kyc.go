...
func RevokeKyc(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	if req.ClientToken == "" {
	...
	minted, err := t_svc.RevokeKyc(tokenID, userID, kycID, operatorID)
	if err != nil {
