...
func (t_svc *TokenService) AssociateWithToken(tokenID string, account, operatorID string) (*hedera.Status, error) {
	...
	return ht.AssociateWithToken(tokenID, user_account.AccountID, user_key.PrivateKey)
}
