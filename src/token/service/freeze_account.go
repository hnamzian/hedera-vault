...
func (t_svc *TokenService) FreezeAccount(tokenID string, account, kycID, operatorID string) (*hedera.Status, error) {
	...
	return ht.FreezeAccount(tokenID, user_account.AccountID, kyc_key.PrivateKey)
}
