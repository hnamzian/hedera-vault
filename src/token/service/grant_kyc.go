...
func (t_svc *TokenService) GrantKyc(tokenID string, account, kycID, operatorID string) (*hedera.Status, error) {
	...
	return ht.GrantKyc(tokenID, user_account.AccountID, kyc_key.PrivateKey)
}
