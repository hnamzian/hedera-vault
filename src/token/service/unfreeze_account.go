...
func (t_svc *TokenService) UnfreezeAccount(tokenID string, account, kycID, operatorID string) (*hedera.Status, error) {
	...
	return ht.UnfreezeAccount(tokenID, user_account.AccountID, kyc_key.PrivateKey)
}
