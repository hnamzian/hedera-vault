...
func (t_svc *TokenService) MintToken(tokenID string, amount uint64, supplyID, operatorID string) (*hedera.Status, error) {
	...
	return ht.MintToken(tokenID, amount, supply_key.PrivateKey)
}
